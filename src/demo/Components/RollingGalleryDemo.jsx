...
const RollingGalleryDemo = () => {
  ...
  return (
    <TabbedLayout>
      <PreviewTab>
        <Box position="relative" className="demo-container" bg={'#333333'} overflow='hidden' p={0}>
          <Flex h={'100%'} maxW={'600px'} alignItems="center" justifyContent="center" direction="column">
            <Text mt={6} textAlign="center" position="absolute" fontWeight={900} top={{ base: '4em', md: '1em' }} whiteSpace="nowrap" fontSize={{ base: '1.6em', md: '3rem' }} color="#FFA500">Your trip to Thailand.</Text>
