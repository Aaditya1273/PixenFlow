...
void mainImage(out vec4 C, in vec2 U) {
  ...
  c.r += 0.3; // Increase red component for orange
  c.g += 0.1; // Slight green for orange tint
  c.b = c.b * 0.1; // Reduce blue to enhance orange
  if (max(c.r, max(c.g, c.b)) < 0.15) discard;
  C = vec4(c * 0.5 + c.brg * 0.5 + c * c, uOpacity);
}
